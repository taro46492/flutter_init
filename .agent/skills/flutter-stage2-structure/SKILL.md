...
description: |
  ...
  ファイル構成を計画し、構造計画書（AI/document/structure_plan.md）を作成する。
...
1. **事前準備**
   - `AI/document/structure_plan.md` のテンプレートを確認
   - メタ情報を暫定入力
   - 仕様書 `AI/document/application_specification.md` を確認
...
2. **修正点の反映**
   - `AI/architecture/lib/features/features_architecture.md` との整合性確認
   - 計画の解像度向上
...
- 構造計画書テンプレート: `AI/document/structure_plan.md`
